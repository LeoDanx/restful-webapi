insert into user_details(id,birth_date,name) values(10001,current_date(),'angel');
insert into user_details(id,birth_date,name) values(10002,current_date(),'david');
insert into user_details(id,birth_date,name) values(10003,current_date(),'rosa');
